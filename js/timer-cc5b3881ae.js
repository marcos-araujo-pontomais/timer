    ...
    function e(e, s) {
        ...
        return "area" === r ? (n = e.parentNode,
            ...
            !(!e.href || !o || "map" !== n.nodeName.toLowerCase()) && (a = t("img[usemap='#" + o + "']")[0],
                !!a && i(a))) : (/^(input|select|textarea|button|object)$/.test(r) ? !e.disabled : "a" === r ? e.href || s : s) && i(e)
    }
    function i(e) {
                        ...
                        "right" === n.my[0] ? T.left -= c : "center" === n.my[0] && (T.left -= c / 2),
                            ...
                            n.using && (l = function (t) {
                                ...
                                m < c && r(e + i) < m && (h.horizontal = "center"),
                                    ...
                                    a(r(e), r(i)) > a(r(s), r(o)) ? h.important = "horizontal" : h.important = "vertical",
            ...
            t.ui.position = {
                fit: {
                    left: function (t, e) {
                        ...
                        e.collisionWidth > o ? h > 0 && l <= 0 ? (i = t.left + h + e.collisionWidth - o - n,
                            t.left += h - i) : l > 0 && h <= 0 ? t.left = n : h > l ? t.left = n + o - e.collisionWidth : t.left = n : h > 0 ? t.left += h : l > 0 ? t.left -= l : t.left = a(t.left - r, t.left)
                    },
                    top: function (t, e) {
                        ...
                        e.collisionHeight > o ? h > 0 && l <= 0 ? (i = t.top + h + e.collisionHeight - o - n,
                            t.top += h - i) : l > 0 && h <= 0 ? t.top = n : h > l ? t.top = n + o - e.collisionHeight : t.top = n : h > 0 ? t.top += h : l > 0 ? t.top -= l : t.top = a(t.top - r, t.top)
                    }
                },
                flip: {
                    left: function (t, e) {
                        ...
                        u < 0 ? (i = t.left + d + p + f + e.collisionWidth - a - o,
                            (i < 0 || i < r(u)) && (t.left += d + p + f)) : c > 0 && (s = t.left - e.collisionPosition.marginLeft + d + p + f - h,
                    ...
                    top: function (t, e) {
                        ...
                        u < 0 ? (s = t.top + p + f + m + e.collisionHeight - a - o,
                            (s < 0 || s < r(u)) && (t.top += p + f + m)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - h,
    ...
    t.ui.position,
        t.widget("ui.accordion", {
            ...
            _eventHandler: function (e) {
                ...
                e.preventDefault(),
                    o && !i.collapsible || this._trigger("beforeActivate", e, l) === !1 || (i.active = !a && this.headers.index(n),
                        this.active = o ? t() : n,
                        this._toggle(l),
        ...
        _setOption: function (t, e) {
            return this._super(t, e),
                "disabled" === t ? (this.widget().toggleClass("ui-state-disabled", !!e),
                    ...
                    void (e && ("checkbox" === this.type || "radio" === this.type ? this.buttonElement.removeClass("ui-state-focus") : this.buttonElement.removeClass("ui-state-focus ui-state-active")))) : void this._resetButton()
        },
        refresh: function () {
    ...
    t.extend(n.prototype, {
        ...
        _generateHTML: function (t) {
            ...
            for (t.drawMonth = Z,
                ...
                s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>",
                n = this._get(t, "nextText"),
                n = K ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + $, 1)), this._getFormatConfig(t)) : n,
                o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>",
                ...
                for (k = "",
                    ...
                    for (T += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I + "'>" + (/all|left/.test(I) && 0 === x ? B ? o : s : "") + (/all|right/.test(I) && 0 === x ? B ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || C > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    ...
                    for (T += P + "</tr></thead><tbody>",
                        ...
                        E = 0; E < H; E++) {
                        for (T += "<tr>",
                            O = c ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(N) + "</td>" : "",
                            w = 0; w < 7; w++)
                            W = g ? g.apply(t.input ? t.input[0] : null, [N]) : [!0, ""],
                                R = N.getMonth() !== Z,
                                F = R && !_ || !W[0] || Q && N < Q || J && N > J,
                                O += "<td class='" + ((w + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (R ? " ui-datepicker-other-month" : "") + (N.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === N.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (F ? " " + this._unselectableClass + " ui-state-disabled" : "") + (R && !v ? "" : " " + W[1] + (N.getTime() === G.getTime() ? " " + this._currentClass : "") + (N.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) + "'" + (R && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (F ? "" : " data-handler='selectDay' data-event='click' data-month='" + N.getMonth() + "' data-year='" + N.getFullYear() + "'") + ">" + (R && !v ? "&#xa0;" : F ? "<span class='ui-state-default'>" + N.getDate() + "</span>" : "<a class='ui-state-default" + (N.getTime() === Y.getTime() ? " ui-state-highlight" : "") + (N.getTime() === G.getTime() ? " ui-state-active" : "") + (R ? " ui-priority-secondary" : "") + "' href='#'>" + N.getDate() + "</a>") + "</td>",
            ...
            drag: function (e, i, s) {
                ...
                for (d = s.snapElements.length - 1; d >= 0; d--)
                    h = s.snapElements[d].left - s.margins.left,
                        ...
                        v < h - m || g > l + m || b < u - m || _ > c + m || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
                    ...
                    /^(se|s|e)$/.test(r) ? (i.size.width = p,
                        i.size.height = f) : /^(ne)$/.test(r) ? (i.size.width = p,
                            ...
                            i.position.top = a.top - d) : /^(sw)$/.test(r) ? (i.size.width = p,
                                i.size.height = f,
                                i.position.left = a.left - c) : ((f - u <= 0 || p - l <= 0) && (e = i._getPaddingPlusBorderDimensions(this)),
        ...
        t.ui.intersect = function () {
            ...
            return function (e, i, s, n) {
                ...
                switch (s) {
                    ...
                    case "touch":
                        return (a >= u && a <= d || h >= u && h <= d || a < u && h > d) && (o >= l && o <= c || r >= l && r <= c || o < l && r > c);
                    default:
                        return !1
                }
            }
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _slide: function (t, e, i) {
                ...
                this.options.values && this.options.values.length ? (s = this.values(e ? 0 : 1),
                    2 === this.options.values.length && this.options.range === !0 && (0 === e && i > s || 1 === e && i < s) && (i = s),
            ...
            _refreshValue: function () {
                var e, i, s, n, o, a = this.options.range, r = this.options, h = this, l = !this._animateOff && r.animate, u = {};
        ...
        t.widget("ui.tabs", {
            ...
            _setupDisabled: function (e) {
                ...
                for (var i, s = 0; i = this.tabs[s]; s++)
                    e === !0 || t.inArray(s, e) !== -1 ? t(i).addClass("ui-state-disabled").attr("aria-disabled", "true") : t(i).removeClass("ui-state-disabled").removeAttr("aria-disabled");
            ...
            _eventHandler: function (e) {
                ...
                e.preventDefault(),
                    o.hasClass("ui-state-disabled") || o.hasClass("ui-tabs-loading") || this.running || a && !i.collapsible || this._trigger("beforeActivate", e, u) === !1 || (i.active = !r && this.tabs.index(o),
                        this.active = a ? t() : o,
...
runloop.colorForType = function (t) {
    var e = ["#222", "#DB2C2C", "#F27900", "#D9B516", "#29CC52", "#31CAFD", "#189EF2", "#BA419E", "#E62E5F", "#8539BF"];
    return function (t) {
...
runloop.string = function () {
    ...
    function i(e) {
        ...
        return e -= 60 * n,
            i = s > 0 ? s + ":" + t(n, 0, 2) + ":" + t(e, 0, 2) : t(n, 0, 2) + ":" + t(e, 0, 2)
    }
    function s(t) {
        for (var e = [1, 60, 3600, 86400, 604800, 31536e3], i = t.split(":"), s = 0, n = i.length - 1, o = 0; n >= 0; n--,
            o++)
            s += i[n] * e[o];
        return s
    }
...
runloop.intervalsForDefinition = function (t) {
    function e(t) {
        ...
        var a, r, h = {}, l = 0, u = t.duration, c = t.name, d = t.color, p = 1 == t.rest;
        return h.name = c,
            h.duration = u,
            h.color = d,
            h.rest = p,
    ...
    function s(t) {
        var i, s, n = 0, o = 0, a = [];
        for (t.warmup && t.warmup.duration > 0 && (i = e(t.warmup),
            i.isRest = !0,
            a[n++] = i),
            s = 0; s < t.numberOfSets; s++)
            (s > 0 || t.start_low) && (i = e(t.lowIntensity),
                ...
                i.number = o + "/" + t.numberOfSets,
                a[n++] = i;
        return t.cooldown && t.cooldown.duration > 0 && (i = e(t.cooldown),
            i.isRest = !0,
            a[n++] = i),
            a
    }
    ...
    function o(t) {
        var i = [];
        return t.warmup && t.warmup.duration > 0 && (interval = e(t.warmup),
            interval.isRest = !0,
            i.push(interval)),
            i = t.group === !0 ? i.concat(a(t)) : i.concat(r(t)),
            t.cooldown && t.cooldown.duration > 0 && (interval = e(t.cooldown),
                interval.isRest = !0,
                i.push(interval)),
            i
    }
    function a(t) {
        var i, s, n, o = [], a = 0, r = 0, h = 0;
    ...
    function l(t) {
        var i, s, n, o = [], a = 0, r = 0, h = 0, l = t.numberOfSets;
        for (t.warmup && t.warmup.duration > 0 && (i = e(t.warmup),
            i.isRest = !0,
            o[h++] = i),
            n = 0; n < t.tabatas.length; n++)
            for (a = 0,
                r += 1,
...
runloop.createTimer = function (t) {
    ...
    var g, v, _ = {}, b = {}, y = runloop.createClock(), w = 0, x = 0;
    return _.elapsed = c,
        _.remaining = d,
        _.intervalCount = p,
        _.setIntervals = e,
...
!function (t, e) {
    function i() {
        var t = $(".timer-main")
            , e = t.parent();
        t.css("top", e.height() * -.22),
            t.css("font-size", .7 * e.height());
        var i = $(".timer-accessory");
        i.css("top", .55 * e.height()),
            i.css("padding-right", .03 * e.height()),
            i.css("padding-left", .03 * e.height()),
            i.find("h3").css("font-size", .045 * e.height()),
            i.find("p").css("font-size", .1 * e.height()).css("top", e.height() * -.02);
        var s = $(".timer li");
        s.css("font-size", .07 * e.height()),
            s.css("padding-top", .05 * e.height()),
            $(".timer-reset").css("font-size", .07 * e.height()).css("padding-top", .06 * e.height()),
            $(".timer-start-toggle").css("font-size", .07 * e.height()).css("padding-top", .06 * e.height())
    }
    $(t).resize(i),
        $(document).ready(i)
}(window);
...
!function (t, e) {
    var i = runloop.string.fromDuration
        ...
        , r = $(".timer-reset")
        , h = new Audio("/sounds/smw_power-up_appears.wav")
        , l = new Audio("../sounds/smw_power-up_appears.wav")
        , u = runloop.createTimer().on("update", function () {
            $(".timer-elapsed p").text(i(u.elapsed())),
                $(".timer-remaining p").text(i(u.remaining() + .999)),
                $(".timer-main").text(i(u.interval().remaining() + .999))
        }).on("change", function () {
            $(".timer-interval-count p").text(u.intervalCount()),
                ...
                o.animate({
                    left: -50 * u.currentIntervalIndex() + "%"
                })
        }).on("complete", function () {
            $(".timer-main").text(i(0)),
                $(".timer-remaining p").text(i(0)),
                n.animate({
                    backgroundColor: runloop.colorForType(0)
                }, 250),
                o.animate({
                    left: -50 * s.length + "%"
                })
    ...
    for (var d, p = function (t) {
        ...
        d = $("<li>" + s[f].name + "</li>").css("background-color", runloop.colorForType(s[f].color)).css("width", 100 / (s.length + 1) + "%"),
            d.appendTo(o),
            d.click(p(f));
    d = $("<li>End of Timer</li>").css("background-color", runloop.colorForType(0)).css("width", 100 / (s.length + 1) + "%"),
        d.appendTo(o)
}(window);
